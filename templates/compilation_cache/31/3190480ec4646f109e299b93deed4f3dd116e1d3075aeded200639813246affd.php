...
class __TwigTemplate_b9d6e6b917713e79bbbbd57fb2bf67588df9ff5547f4d3b3f1992e3fd977fe1b extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"timeline\">
  ";
    ...
    ";
            // line 88
            if ((twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 88) == 1)) {
                // line 89
                echo "    <div class=\"timeline-left\"><a class=\"timeline-icon\"></a></div>
    ";
            } else {
...
<!--time line end-->
", "parts/slide-right.html.twig", "/home/carlos-sweb/Escritorio/carlos-sweb-cv/templates/parts/slide-right.html.twig");
    }
}
